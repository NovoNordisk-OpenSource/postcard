...
#> ✔ 1 of 3 resampling: mod_mars (326ms)
#> i  No tuning parameters. `fit_resamples()` will be attempted
#> i 2 of 3 resampling: mod_lm
#> ✔ 2 of 3 resampling: mod_lm (206ms)
#> i 3 of 3 tuning:     mod_gbt
#> ✔ 3 of 3 tuning:     mod_gbt (1.4s)
...
#> function (psi1, psi0) 
#> psi1/psi0
#> <bytecode: 0x556cfdef1970>
#> <environment: 0x556d09a86188>
#> 
#> $d0
#> function (psi1, psi0) 
#> -(psi1/psi0^2)
