...
#> function (psi1, psi0) 
#> psi1 - psi0
#> <bytecode: 0x560aca32d938>
#> <environment: 0x560aca32dc80>
#> attr(,"margin")
#> [1] 0
#> attr(,"alpha")
#> [1] 0.05
