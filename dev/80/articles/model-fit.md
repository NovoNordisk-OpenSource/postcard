...
#> ✔ 1 of 3 resampling: mod_mars (336ms)
#> i  No tuning parameters. `fit_resamples()` will be attempted
#> i 2 of 3 resampling: mod_lm
#> ✔ 2 of 3 resampling: mod_lm (234ms)
...
#> function (psi1, psi0) 
#> psi1/psi0
#> <bytecode: 0x555f481e1a60>
#> <environment: 0x555f53004e18>
#> 
#> $d0
#> function (psi1, psi0) 
#> -(psi1/psi0^2)
