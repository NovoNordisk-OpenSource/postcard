...
#> ✔ 1 of 3 resampling: mod_mars (305ms)
#> i  No tuning parameters. `fit_resamples()` will be attempted
#> i 2 of 3 resampling: mod_lm
#> ✔ 2 of 3 resampling: mod_lm (209ms)
...
#> function (psi1, psi0) 
#> psi1/psi0
#> <bytecode: 0x55d84af03890>
#> <environment: 0x55d8552710e0>
#> 
#> $d0
#> function (psi1, psi0) 
#> -(psi1/psi0^2)
