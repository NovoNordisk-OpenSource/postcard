...
#> ✔ 1 of 3 resampling: mod_mars (356ms)
#> i  No tuning parameters. `fit_resamples()` will be attempted
#> i 2 of 3 resampling: mod_lm
#> ✔ 2 of 3 resampling: mod_lm (257ms)
...
#> function (psi1, psi0) 
#> psi1/psi0
#> <bytecode: 0x56091a6197a0>
#> <environment: 0x560929278648>
#> 
#> $d0
#> function (psi1, psi0) 
#> -(psi1/psi0^2)
