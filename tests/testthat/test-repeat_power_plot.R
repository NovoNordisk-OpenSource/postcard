...
test_that("`repeat_power_marginaleffect` works", {
  ...
  expect_snapshot(rpm)
  expect_doppelganger("Vertical and horizontal lines meet where power curve crosses horizontal line - marginaleffect",
                      plot(rpm))
})
...
test_that("`repeat_power_linear` works", {
  ...
  expect_snapshot(rpl)
  expect_doppelganger("Vertical and horizontal lines meet where power curve crosses horizontal line - linear",
                      plot(rpl))
})
